package com.altix.ezpark.iam.infrastructure.authorization.sfs.configuration;

import com.altix.ezpark.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import com.altix.ezpark.iam.infrastructure.hashing.bcrypt.BCryptHashingService;
import com.altix.ezpark.iam.infrastructure.tokens.jwt.BearerTokenService;
    ...
    http.csrf(csrfConfigurer -> csrfConfigurer.disable())
        ...
        .authorizeHttpRequests(
            authorizeRequests -> authorizeRequests.requestMatchers(
                ...
                "/swagger-ui/**", "/swagger-resources/**", "/webjars/**","/authentication/**", "/actuator/**")
                .permitAll()
                .anyRequest()
                .authenticated());

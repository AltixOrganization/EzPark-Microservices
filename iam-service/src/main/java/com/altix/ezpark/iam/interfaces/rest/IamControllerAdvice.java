...
import com.altix.ezpark.iam.domain.model.exceptions.*;
...
import static com.altix.ezpark.iam.infrastructure.utils.IamErrorCatalog.*;

@RestControllerAdvice(basePackages = "com.altix.ezpark.iam")
